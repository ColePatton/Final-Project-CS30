...
#-----Game Sounds------
shoot_sound = pygame.mixer.Sound(path.join(snd_dir, 'gunshot.mp3'))#shooting
hurt_sound = pygame.mixer.Sound(path.join(snd_dir, 'oof.mp3'))#hurting the enemy or player
pygame.mixer.music.load(path.join(snd_dir, 'background music.mp3'))#music
